...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        if (data['status'] == 'error') {
            ...
            bshow = false;
            bselfdefine = false;
            schemeback = data['datascalebackmsg'];
            if(schemeback == "3 3 2") {
                jsonstr = '{\
                "record":\
                    [{\
...
truckvec[19]=mtruck.make(mpos.make(588,118),2);
        ...
        jsonstr = data['linkoutputbackmsg'];
        jsonroot = jQuery.parseJSON(jsonstr);
        minit2(); 
        }
        },
